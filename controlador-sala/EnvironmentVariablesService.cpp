...
class BLEServerService; // Resolucao de Dependencia Circular
// Resolver isso aqui. Dependencia Circular
// EnvironmentVariableService >> BLEServerService >>  Hardware >> Config >> UtilsService >> EnvironmentVariableService
...
std::vector<struct Reserva> EnvironmentVariablesService::__reservations; 
